-- 207_task_usage_hourly_cost.down.sql
-- Restore migration 102's rollup function verbatim, then drop the column.
...
ALTER TABLE task_usage_hourly DROP COLUMN IF EXISTS total_cost_usd;
