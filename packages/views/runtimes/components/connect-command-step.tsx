...
// Pieces the "Add a computer" dialog's two bodies (daemon and webhook)
// share: a numbered command row with a copy button, and the "waiting for
// your computer" indicator. Mirrors onboarding/CliInstallInstructions.
